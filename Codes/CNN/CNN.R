...
setwd(ObjectsDir) #AnimalDir or ObjectsDir

pic1 <- c('b1.jpg', 'b2.jpg', 'b3.jpg', 'b4.jpg', 'b5.jpg',
          'c1.jpg', 'c2.jpg', 'c3.jpg', 'c4.jpg', 'c5.jpg',
          'p1.jpg', 'p2.jpg', 'p3.jpg', 'p4.jpg', 'p5.jpg')
train <- list()
for (i in 1:15) {train[[i]] <- readImage(pic1[i])}

pic2 <- c('b6.jpg', 'c6.jpg', 'p6.jpg')
test <- list()
...
save.image("Results-objects-arq1.RData")
